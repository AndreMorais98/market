    ...
    <div>
          ...
          <div class="container">
            <div class="front-text">
              <div class="center">
                ...
                <h3>The first world NFT Market to guarantee the authenticity of your luxury object</h3><button class="btn-claim"><a class="button" href="/market">Explore it Now</a></button>
              </div>
            </div>
          </div>
        </div>
      ...
      <div class="principles">
        <div class="container">
          ...
          <div class="list-principle-right">
            <div class="img-bg-wrapper">
              <h1>Control</h1>
